...
movies = pickle.load(open("C:\\Users\\User\\Desktop\\models\\model (2).pkl", "rb"))
similarity = pickle.load(open('C:\\Users\\User\\Desktop\\models\\similarity (1).pkl', 'rb'))
...
def recommend():
    ...
    return render_template('index.html', movie_list=movies['title'].tolist(), recommended_movie_titles=recommended_movie_titles, recommended_movie_posters=recommended_movie_posters)
